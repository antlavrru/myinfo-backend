...
app.use(cors()); // Включи CORS для взаимодействия фронтенда с бэкендом
app.use(express.json()); // Для парсинга JSON-тел запросов
app.use(express.urlencoded({ extended: true })); // Для парсинга URL-encoded тел запросов (если потребуется)
...
// Этот маршрут остаётся без изменений, кроме проверки на BOT_TOKEN в validateTelegramInitData
